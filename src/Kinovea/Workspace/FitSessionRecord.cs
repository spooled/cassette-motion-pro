...
namespace CassetteMotionPro.Workspace
{
    ...
    public class FitSessionRecord
    {
        ...
        public string ReportApprovalNotes { get; set; }
        public string ReportApprovalFingerprint { get; set; }
        public DateTime ReportApprovedUtc { get; set; }
        public string ReportDeliveryFormat { get; set; }
        public string ReportDeliveryOutputPath { get; set; }
        public DateTime ReportDeliveryPreparedUtc { get; set; }
        ...
        public string PedalCycleTrendBeforeSummary { get; set; }
        public string PedalCycleTrendAfterSummary { get; set; }
        public string PedalCycleTrendBeforeEvidencePath { get; set; }
        public string PedalCycleTrendAfterEvidencePath { get; set; }
        ...
        public string DualCameraRightRole { get; set; }
        public string DualCameraEventOneLeftMs { get; set; }
        public string DualCameraEventOneRightMs { get; set; }
        public string DualCameraEventTwoLeftMs { get; set; }
        public string DualCameraEventTwoRightMs { get; set; }
        public string DualCameraSynchronizationSummary { get; set; }
