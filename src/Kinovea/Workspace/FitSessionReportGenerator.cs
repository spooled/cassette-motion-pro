...
namespace CassetteMotionPro.Workspace
{
    public static class FitSessionReportGenerator
    {
        ...
        private static string BuildHtml(ClientRecord client, FitSessionRecord session)
        {
            ...
            html.AppendLine(".media-card{border:1px dashed #c9d5cf;border-radius:16px;background:#f7f9f8;min-height:160px;display:flex;align-items:center;justify-content:center;text-align:center;color:#718078;}");
            ...
            html.AppendLine("<div class=\"media-card\"><div><strong>Before</strong><br><span>Image placeholder</span></div></div>");
            html.AppendLine("<div class=\"media-card\"><div><strong>After</strong><br><span>Image placeholder</span></div></div>");
            html.AppendLine("</div>");
            ...
            html.AppendLine("<div class=\"footer\">Generated by Cassette Motion Pro v0.5.1.</div>");
            html.AppendLine("</div>");
            html.AppendLine("</div>");
            html.AppendLine("</body>");
            html.AppendLine("</html>");
