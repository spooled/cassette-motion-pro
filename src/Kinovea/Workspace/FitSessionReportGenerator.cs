...
namespace CassetteMotionPro.Workspace
{
    public static class FitSessionReportGenerator
    {
        ...
        private static string BuildHtml(ClientRecord client, FitSessionRecord session)
        {
            ...
            html.AppendLine("@media(max-width:760px){.hero-grid,.summary,.fit-summary,.media-grid{grid-template-columns:1fr}.fit-summary .wide{grid-column:auto}}");
            html.AppendLine("</style>");
            html.AppendLine("</head>");
            ...
            html.AppendLine("<div class=\"footer\"><span>Generated by Cassette Motion Pro v0.10.5</span><span>Professional bike fitting report</span></div>");
            html.AppendLine("</div>");
            html.AppendLine("</div>");
            html.AppendLine("</body>");
            html.AppendLine("</html>");
