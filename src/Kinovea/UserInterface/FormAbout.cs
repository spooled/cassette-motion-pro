...
namespace Kinovea.Root
{
    public partial class FormAbout : Form
    {
        ...
        {
            this.Text = "   About " + Software.ApplicationName;
            logoPictureBox.Image = BrandingAssets.Logo;
            logoPictureBox.SizeMode = PictureBoxSizeMode.Zoom;
            labelCopyright.Text = string.Format("© {0} Cassette Fit Studio. Kinovea engine © 2006-{0} Joan Charmant and contributors.", year);
            lblKinovea.Text = string.Format("{0} - {1}", Software.ApplicationName, Software.Version);
            lnkKinovea.Links.Clear();
            lnkKinovea.Text = "Built on the Kinovea engine - kinovea.org";
