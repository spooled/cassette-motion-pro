...
namespace Kinovea.Root
{
    ...
    public partial class PreferencePanelGeneral : UserControl, IPreferencePanel
    {
        ...
        private void ImportPreferences()
        {
            ...
            fitterName = PreferencesManager.GeneralPreferences.FitterName;
            studioPhone = PreferencesManager.GeneralPreferences.StudioPhone;
            studioEmail = PreferencesManager.GeneralPreferences.StudioEmail;
            studioWebsite = PreferencesManager.GeneralPreferences.StudioWebsite;
        }
        private void InitPage()
        {
            ...
            tbFitterName.Text = fitterName;
            tbStudioPhone.Text = studioPhone;
            tbStudioEmail.Text = studioEmail;
            tbStudioWebsite.Text = studioWebsite;
        ...
        private void tbFitterName_TextChanged(object sender, EventArgs e)
        {
            fitterName = tbFitterName.Text;
        }
        private void tbStudioPhone_TextChanged(object sender, EventArgs e)
        {
            studioPhone = tbStudioPhone.Text;
        }
        private void tbStudioEmail_TextChanged(object sender, EventArgs e)
        {
            studioEmail = tbStudioEmail.Text;
        }
        private void tbStudioWebsite_TextChanged(object sender, EventArgs e)
        {
            studioWebsite = tbStudioWebsite.Text;
        }
        ...
        public void CommitChanges()
        {
            ...
            PreferencesManager.GeneralPreferences.FitterName = fitterName;
            PreferencesManager.GeneralPreferences.StudioPhone = studioPhone;
            PreferencesManager.GeneralPreferences.StudioEmail = studioEmail;
            PreferencesManager.GeneralPreferences.StudioWebsite = studioWebsite;
        }
    }
}
