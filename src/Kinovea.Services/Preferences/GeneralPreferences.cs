...
namespace Kinovea.Services
{
    public class GeneralPreferences : IPreferenceSerializer
    {
        ...
        {
            get { BeforeRead(); return fitterName; }
            set { fitterName = value; Save(); }
        }
        public string StudioPhone
        {
            get { BeforeRead(); return studioPhone; }
            set { studioPhone = value; Save(); }
        }
        public string StudioEmail
        {
            get { BeforeRead(); return studioEmail; }
            set { studioEmail = value; Save(); }
        }
        public string StudioWebsite
        {
            get { BeforeRead(); return studioWebsite; }
            set { studioWebsite = value; Save(); }
        }
        ...
        public void WriteXML(XmlWriter writer)
        {
            ...
            writer.WriteElementString("FitterName", fitterName);
            writer.WriteElementString("StudioPhone", studioPhone);
            writer.WriteElementString("StudioEmail", studioEmail);
            writer.WriteElementString("StudioWebsite", studioWebsite);
            ...
            while (reader.NodeType == XmlNodeType.Element)
            {
                switch (reader.Name)
                {
                    ...
                    case "Pointer":
                        ...
                        break;
                    case "FitterName":
                        fitterName = reader.ReadElementContentAsString();
                        break;
                    case "StudioPhone":
                        studioPhone = reader.ReadElementContentAsString();
                        break;
                    case "StudioEmail":
                        studioEmail = reader.ReadElementContentAsString();
                        break;
                    case "StudioWebsite":
                        studioWebsite = reader.ReadElementContentAsString();
                        break;
